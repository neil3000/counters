...
/**
 * Waits for and returns the `rn3TopAppBar`
 */
fun MacrobenchmarkScope.getTopAppBar(): UiObject2 { //TODO neil: recheck
    device.wait(Until.hasObject(By.res("rn3TopAppBar")), 2_000)
    return device.findObject(By.res("rn3TopAppBar"))
}
