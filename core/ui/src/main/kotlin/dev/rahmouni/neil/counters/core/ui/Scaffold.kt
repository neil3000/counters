...
import dev.rahmouni.neil.counters.core.ui.FeedbackContext.FeedbackEmptyContext.getID
    ...
    when {
        ...
        topAppBarStyle == TopAppBarStyle.LARGE && windowHeightClass != COMPACT -> Rn3ScaffoldImpl(
            ...
            Rn3LargeTopAppBar(
                ...
                onFeedbackIconButtonClicked = if (feedbackContext is FeedbackEmptyContext) null else showFeedbackModal,
            )
        }
...
fun Rn3ScaffoldImpl(
    ...
    Scaffold(
        ...
        Column {
            ...
            if (feedbackContext is FeedbackContext.FeedbackScreenContext) {
                FeedbackBottomSheet(feedbackContext.getID(), showFeedbackModal) {
